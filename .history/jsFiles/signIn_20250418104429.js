...
app.post('/logs', (req, res) => {
  ...
  db.logs.push(newLog);
  fs.writeFileSync(account, JSON.stringify(db, null, 2));
...
//   let db;
//   try {
//     db = JSON.parse(fs.readFileSync(accountPath, 'utf-8'));
//   } catch (err) {
...
//   if (!Array.isArray(latestLog.logs)) {
//     latestLog.logs = [];
//   }

//   const newEntry = {
//     id: latestLog.logs.length + 1,
//     productId: productId || null, // Handle case where productId might be undefined
//     action,
//     timestamp: new Date().toISOString()
//   };

//   latestLog.logs.push(newEntry);
