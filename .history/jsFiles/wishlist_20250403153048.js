...
router.post('/api/wishlist/:productId', authenticate, (req, res) => {
...
router.post('/api/guest/wishlist/:productId', (req, res) => {
  const { productId } = req.params;
...
// 4. Sync Endpoint
router.post('/api/wishlist/sync', authenticate, (req, res) => {
