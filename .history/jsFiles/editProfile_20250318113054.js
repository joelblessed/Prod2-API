...
router.use("/public/images/profileImages", express.static("public/images/profileImages")); // Serve uploaded images

// Multer Configuration for Image Uploads
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, "public/images/profileImages"); // Save images in "uploads" folder
  },
...
router.put("/profile/update-image/:userId", upload.single("profileImage"), (req, res) => {
  ...
  users[userIndex].profileImage = `/images/profileImage/${req.file.filename}`;
  writeUsers(users);
